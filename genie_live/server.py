...
.time{color:#e94560;font-family:monospace} .question{padding:5px;margin:5px 0;border-left:3px solid #3498db}
...
function renderState(s){
  ...
  (s.recent_transcript||[]).forEach(seg=>{
    ...
    t+='<div><span class="time">['+String(m).padStart(2,'0')+':'+String(sc).padStart(2,'0')+']</span> '+seg.text+'</div>';
  });
